...
public class Test01 {
	...
	public static void main(String[] args){
		...
		for(int i = 0; i < scores.length; i++){
			s = new Score(); // 학생의 성적 정보를 입력 받을 인스턴스 준비
			...
			System.out.print("수학?");
			s.math = Integer.parseInt(sc.nextLine());
		...
		for(int i = 0; i<count; i++){
			s = scores[i]; // 학생의 성정 정보를 입력 받을 인스턴스 준비
			//System.out.println("홍길동 님의 총점과 평균은 다음과 같습니다.");
			System.out.println(s.name + " 님의 총점과 평균은 다음과 같습니다. ");
