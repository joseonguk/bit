...
public class Jdbc01 {
  public static void main(String[] args) throws Exception {
    ...
    // - 동작원리
    //  1) DriverManager의 gerConnection() 호출
    ...
    Connection con = DriverManager.getConnection(
        "jdbc:mysql://localhost:3306/bitdb",  /* DBMS의 접속하는 JDBC URL 주소*/
        "bit",   /* DBMS에 접속할 때 사용할 사용자 아이디*/
        "1111"  /* DBMS에 접속할 때 사용할 사용자 암호*/ );
    
    
    
    // 3. Connection 역할자를 통해 Statement 역할자를 얻기
    // - Statement 객체
    //   => DBMS에 SQL을 전다하는 역할 수행
