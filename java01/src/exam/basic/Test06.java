 ...
 * - short 끼리의 연산 결과 int
 * - long 끼리의 연산 결과 long
 * - 서로 다른 타입의 데이터를 연산할 때 다음의 규칙에 따라 데이터형을 일치시켜서 연산을 수행한다.
...
public class Test06 {
	...
	public static void main(String[] args) {
		byte b1 = 56; 	// 상수인 경우 변수에 저장할 수 있다면 승인해줌
		...
		//기본 연산 int 이기 때문에 byte 값을 임시 int 변수에 저장한 다음 계산 수행
		//byte b4 = b2 + b3; //내부적으로 b2와 b3 값을 저장할 int 메모리가 준비된다.
		int i1 = b2 + b3;
		
		short s1 = 10;
		short s2 = 20;
		//short s3 = s1 + s2; 		//위와 같음
		int i2 = s1 + s2;
