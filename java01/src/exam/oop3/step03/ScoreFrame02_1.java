...
public class ScoreFrame02_1 extends Frame{
  ...
  ScoreDao scoreDao;
    ...
    btn.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        score.setName(tfName.getName());
        //score.kor = Integer.parseInt(tfKor.getText());
        //score.eng = Integer.parseInt(tfEng.getText());
        //score.math = Integer.parseInt(tfMath.getText());
	...
	private Panel createRowPanel(String title, Component comp){    
	  // (String title, TextField comp) 이렇게도 가능함
	  // 위에 처럼 쓴 이유는 component의 하위 모든 걸 받을 수 있게 하기 위해서
