 ...
 * - .class 파일에 주석을 남길 수 있음 => .class 파일에 잇는 애노테이션을 추출할 수 있음
 */
...
public class Servlet07 extends HttpServlet{
  /* @Override => 컴파일러에게 전달하는 주석 => .class 파일에 포함되지 않는다.
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      fromSelectde[from] = "selected";
    } catch(Exception e){}
    
    try {
      to = Integer.parseInt(request.getParameter("to"));
      toSelectde[to] = "selected";
    } catch(Exception e){}
    ...
    out.println("    <option value='0' "+ fromSelectde[0] + ">cm</option>");
    out.println("    <option value='1' "+ fromSelectde[1] + ">inch</option>");
    out.println("    <option value='2' "+ fromSelectde[2] + ">yd</option>");
    out.println("    <option value='3' "+ fromSelectde[3] + ">km</option>");
    out.println("  </select>");
    out.println("  <label>=></label>");
    out.println("  <select name='to'>");
    out.println("   <option value='0' "+ toSelectde[0] + ">cm</option>");
    out.println("   <option value='1' "+ toSelectde[1] + ">inch</option>");
    out.println("   <option value='2' "+ toSelectde[2] + ">yd</option>");
    out.println("   <option value='3' "+ toSelectde[3] + ">km</option>");
    out.println(" </select>");
